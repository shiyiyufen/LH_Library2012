...
typedef enum 
{
    ...
    LHProgressHUDModeIndeterminate,
    /** Progress is shown using a MBRoundProgressView. */
	LHProgressHUDModeDeterminate,
	/** Shows a custom view */
...
{
    /** Opacity animation */
    LHProgressHUDAnimationFade,
    /** Opacity + scale animation */
    LHProgressHUDAnimationZoom
} LHProgressHUDAnimation;

/////////////////////////////////////////////////////////////////////////////////////////////

@protocol LHProgressHUDDelegate <NSObject>
 ...
 * The LHProgressHUD window spans over the entire space given to it by the initWithFrame constructor and catches all
 ...
 * - LHProgressHUDModeIndeterminate - shows a UIActivityIndicatorView
 * - LHProgressHUDModeDeterminate - shows a custom round progress indicator (MBRoundProgressView)
 * - LHProgressHUDModeCustomView - shows an arbitrary, user specified view (@see customView)
 *
...
@interface LHProgressHUD : UIView {
    ...
    LHProgressHUDAnimation animationType;
	...
	id<LHProgressHUDDelegate> delegate;
	NSString *labelText;
...
/**
 * The UIView (i.g., a UIIMageView) to be shown when the HUD is in LHProgressHUDModeCustomView.
 * For best results use a 37 by 37 pixel view (so the bounds match the build in indicator bounds). 
 */
@property (retain) UIView *customView;

/** 
 * LHProgressHUD operation mode. Switches between indeterminate (LHProgressHUDModeIndeterminate) and determinate
 * progress (LHProgressHUDModeDeterminate). The default is LHProgressHUDModeIndeterminate.
 *
 * @see LHProgressHUDMode
 */
@property (assign) LHProgressHUDMode mode;

/**
 * The animation type that should be used when the HUD is shown and hidden. 
 *
 * @see LHProgressHUDAnimation
 */
@property (assign) LHProgressHUDAnimation animationType;

/** 
 * The HUD delegate object. If set the delegate will receive hudWasHidden callbacks when the HUD was hidden. The
 * delegate should conform to the LHProgressHUDDelegate protocol and implement the hudWasHidden method. The delegate
 * object will not be retained.
 */
@property (assign) id<LHProgressHUDDelegate> delegate;
